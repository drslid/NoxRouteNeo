...
```bash
sudo curl -fsSL https://raw.githubusercontent.com/drslid/NoxRouteNeo/v1.0.0-alpha.3/install.sh -o /tmp/noxrouteneo-install.sh
sudo env NOXROUTE_REF=v1.0.0-alpha.3 bash /tmp/noxrouteneo-install.sh
```
